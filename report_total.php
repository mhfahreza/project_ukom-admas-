<?php
        ...
        if(!empty($_SESSION['nik_login']))
        {
            ...
            $sql_peng_all = "SELECT * FROM pengaduan INNER JOIN masyarakat ON masyarakat.nik = pengaduan.nik order by id_pengaduan DESC";
...
?>
        ...
        <p><span>jumlah laporan yang masuk <?php echo $jml_peng_all; ?></span></p>
<?php
        }
?>