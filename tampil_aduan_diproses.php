<?php
        ...
        include "function_tanggal.php";
            ...
            if($level == 'masyarakat')
            {
                ...
                $sql_peng_pros = "SELECT * FROM pengaduan WHERE nik = '$nik_login' and status = 'diproses' order by id_pengaduan DESC";
            ...
            else
            {
                ...
                $sql_peng_pros = "SELECT * FROM pengaduan WHERE status = 'diproses' order by id_pengaduan DESC";
                $eks_peng_pros = mysqli_query($koneksi, $sql_peng_pros);
                $jml_peng_pros = mysqli_num_rows($eks_peng_pros);
...
<div class="container-fluid">
    ...
    <div class="container bg-secondary rounded px-3 py-4 my-3">
        ...
        <div class="mb-3 bg-light py-2 rounded px-2">
            <a href="report_proses.php" class="btn btn-success">XLS</a>
        </div>
        <?php
         }
        ?>
