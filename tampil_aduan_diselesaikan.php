<?php
        ...
        include "function_tanggal.php";
            ...
            if($level == 'masyarakat')
            {
                ...
                $sql_peng_selesai = "SELECT * FROM pengaduan WHERE nik = '$nik_login' and status = 'selesai' order by id_pengaduan DESC";
            ...
            else
            {
                ...
                $sql_peng_selesai = "SELECT * FROM pengaduan WHERE status = 'selesai' order by id_pengaduan DESC";
                $eks_peng_selesai = mysqli_query($koneksi, $sql_peng_selesai);
                $jml_peng_selesai = mysqli_num_rows($eks_peng_selesai);
...
<div class="container-fluid">
    ...
    <div class="container bg-secondary rounded px-3 py-4 my-3">
        ...
        <div class="mb-3 bg-light py-2 rounded px-2">
            <a href="report_selesai.php" class="btn btn-success">XLS</a>
        </div>
        <?php
         }
        ?>
